...
<tr>
        ...
        <td>
         <?php 
         $queryq22 = db()->query('SELECT * from la_detail where id_detail="'.$id_detail.'"');
         echo db()->error;
         $rowq22 = $queryq22->fetch_assoc();
			if($rowq22['id_type']==1){
			?>	 <a href="from1pdf.php?id_detail=<?php echo $rowq22['id_detail'];?>" target="_blank">CLICK</a>
			<?php }else{?>
				<a href="from2pdf.php?id_detail=<?php echo $rowq22['id_detail'];?>" target="_blank">CLICK</a>
			<?php }
		?>
        </td>
		</tr>
